...
//        [_voiceBtn setImage:[UIImage nim_imageInKit:@"icon_toolview_voice_pressed"] forState:UIControlStateHighlighted];
        ...
        [_voiceBtn setImage:[UIImage imageNamed:@"语音-点击"] forState:UIControlStateHighlighted];
        [_voiceBtn sizeToFit];
...
//        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"icon_toolview_emotion_pressed"] forState:UIControlStateHighlighted];
        [_emoticonBtn setImage:[UIImage imageNamed:@"表情"] forState:UIControlStateNormal];
         [_emoticonBtn setImage:[UIImage imageNamed:@"表情-点击"] forState:UIControlStateHighlighted];
...
//        [_moreMediaBtn setImage:[UIImage nim_imageInKit:@"icon_toolview_add_pressed"] forState:UIControlStateHighlighted];
        ...
        [_moreMediaBtn setImage:[UIImage imageNamed:@"添加"] forState:UIControlStateNormal];
        [_moreMediaBtn setImage:[UIImage imageNamed:@"添加-点击"] forState:UIControlStateHighlighted];
        ...
        //[_recordButton setBackgroundImage:[[UIImage nim_imageInKit:@"icon_input_text_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch] forState:UIControlStateNormal];
         [_recordButton setBackgroundImage:[[UIImage imageNamed:@"消息输入框"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch] forState:UIControlStateNormal];
        [_recordButton setBackgroundImage:[[UIImage imageNamed:@"按住说话"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch] forState:UIControlStateHighlighted];
...
//        [_inputTextBkgImage setImage:[[UIImage nim_imageInKit:@"icon_input_text_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch]];
        [_inputTextBkgImage setImage:[[UIImage imageNamed:@"消息输入框"] resizableImageWithCapInsets:UIEdgeInsetsMake(15,80,15,80) resizingMode:UIImageResizingModeStretch]];
